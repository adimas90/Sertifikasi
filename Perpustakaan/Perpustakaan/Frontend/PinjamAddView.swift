...
struct PinjamAddView: View {
  ...
  @State var tanggal_kembali = Date()
  ...
  var saveButton: some View {
    Button(action: { self.handleDoneTappedPeminjam(nama_peminjam: Nama(), no_telp: NoTelp(), alamat: Alamat(), judul: Judul(), deskripsi: Deskripsi(), halaman: "", pengarang: Pengarang() , foto: Foto(), tanggal_dipinjam: tanggal_dipinjam, tanggal_kembali: tanggal_kembali )
...
//
//
//  @ObservedObject var viewModelPinjam = PeminjamViewModel()
//  @ObservedObject var viewModel = BookViewModel()
//  var mode: Moder = .edit
//  var completionHandler: ((Result<Action, Error>) -> Void)?
//    
...
//
//  var cancelButton: some View {
//    Button(action: { self.handleCancelTappedPinjam() }) {
//      Text("Batal")
//    }
//  }
//
//  var saveButton: some View {
//    Button(action: { self.handleDoneTappedPinjam(judul: grandSpeech())
//        print("halooww: \(grandSpeech())")
//        
//    }) {
//      Text(mode == .new ? "Selesai" : "Simpan")
//    }
//    .disabled(!viewModelPinjam.modifiedPeminjam)
//  }
//    
...
//    NavigationView {
//      Form {
//        Section(header: Text("Nama Peminjam")) {
//          TextField("Nama Lengkap", text: $viewModelPinjam.identitas_peminjam.nama_lengkap)
//                .disableAutocorrection(true)
//        }
//
//          Section(header: Text("Nomor telepon")) {
//              TextField("Nomor telepon", value: $viewModelPinjam.identitas_peminjam.no_telp, formatter: NumberFormatter())
//                  .disableAutocorrection(true)
//          }
//
//        Section(header: Text("Alamat")) {
//          TextField("Alamat", text: $viewModelPinjam.identitas_peminjam.alamat)
//                .disableAutocorrection(true)
//        }
//
//          Section(header: Text("Identitas Buku")){
//              
//              Text(viewModel.book.deskripsi)
//              TextField("Alamat", text: $viewModel.book.judul_buku)
//                    .disableAutocorrection(true)
//              Text("jumlah ini")
//              Text("pengarang ini")
//              Text("pengarang ini")
...
//          }
//      }
//      .navigationTitle(mode == .new ? "Pinjam Buku" : viewModel.book.judul_buku)
//      .navigationBarTitleDisplayMode(mode == .new ? .inline : .large)
//      .navigationBarItems(
//        leading: cancelButton,
//        trailing: saveButton
...
//                    buttons: [
//                      .destructive(Text("Hapus Buku"),
//                                   action: { self.handleDeleteTappedPinjam() }),
//                      .cancel()
//                    ])
//      }
//    }
//  }
//
//  func handleCancelTappedPinjam() {
//    self.dismiss()
//  }
//
//    func handleDoneTappedPinjam(judul: String) {
//        self.viewModelPinjam.handleDoneTappedPeminjam(judul:judul)
//    self.dismiss()
//  }
//
//  func handleDeleteTappedPinjam() {
//    viewModelPinjam.handleDeleteTappedPeminjam()
//    self.dismiss()
//    self.completionHandler?(.success(.delete))
//  }
//
...
////    let peminjamViewModel = PeminjamViewModel(peminjam: peminjam)
//
//    let book = Book(judul_buku: "", deskripsi: "", pengarang: "", halaman: 0, foto: "", status: true)
//    let bookViewModel = BookViewModel(book: book)
//      return PinjamAddView(
////        viewModelPinjam: peminjamViewModel,
//                           viewModel: bookViewModel ,mode: .edit)
//  }
//}
